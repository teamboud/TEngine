...
public class NormalMappingShader extends ShaderProgram{
    ...
    protected void getAllUniformLocations() {
        ...
        location_tintColour = super.getUniformLocation("tintColour");
    ...
    protected void loadTintColour(float r, float g, float b){
        super.loadVector(location_tintColour, new Vector3f(r,g,b));
    }
